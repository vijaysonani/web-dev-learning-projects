    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          null,
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { width: "200", src: "{ this.props.meta.pster }" })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "p",
          null,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App_css__ = __webpack_require__(/*! ./App.css */ 12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Header__ = __webpack_require__(/*! ./Header */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Movie__ = __webpack_require__(/*! ./Movie */ 10);
throw new Error("Cannot find module \"../src/movies\"");
throw new Error("Cannot find module \"../src/movies\"");
throw new Error("Cannot find module \"./AddMovie\"");
...
var headerText = "Bob's Movie Mojo' React app";
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'App' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Header__["default"], { text: headerText }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'p',
          { className: 'App-intro' },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          Object.keys(this.state.movies).map(function (key) {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Movie__["default"], { key: key, meta: _this2.state.movies[key] });
          })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__AddMovie___default.a, { addMovie: this.addMovieToGallery })
      );
    }

    // create an empty state object for our React app form the movies.js jason file
  ...
  function App() {
    ...
    _this.state = {
      movies: __WEBPACK_IMPORTED_MODULE_4__src_movies__["initialMovies"]
    };

    // There is just one more step we need to complete before the loadAdditionalMovies() method will work.
    // To reference any custom component method, we first need to manually bind it to the component class.

    // This is a quirk of React and is just something you'll have to remember to do.
    // Any time a method is accessed without having been manually bound, React will complain and throw a compilation error.
    _this.loadAdditionalMovies = _this.loadAdditionalMovies.bind(_this);

    // bind the new method to the this so it's available throughout the class when addin a movie
    _this.addMovieToGallery = _this.addMovieToGallery.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function loadAdditionalMovies() {
      var currentMovies = _extends({}, this.state.movies);
      var newMovies = Object.assign(currentMovies, __WEBPACK_IMPORTED_MODULE_4__src_movies__["additionalMovies"]);

      this.setState({ movies: newMovies });
    }
  }, {
    key: 'addMovieToGallery',
    value: function addMovieToGallery(movie) {
      var ts = Date.now();
      var newMovie = {};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_App__ = __webpack_require__(/*! ./utils/App */ 11);
...
// import MovieContainerView from "./components/MovieContainerView";
...
var Hello = function Hello(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'div',
    null,
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__utils_App__["default"], null)
  );
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-6733a67da108a47e974b.js.map